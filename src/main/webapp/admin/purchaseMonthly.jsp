...
<body>
	...
	<div class="container-fluid">
		<div class="row" style="margin-top: 100px">
			<div class="col-md-2">
				<%@ include file="../common/_admin_left_purchase.jspf" %>
			</div>
			<div class="col-md-10">
				<div class="row" style="margin-left: 30px">
					<div class="col-md-7"><h3>월별 구매내역 : ${requestScope.Month}</h3></div>
					<div class="col-md-5"><br>
						<form action="../admin/adminServlet?action=purchaseMonthly&page=1" class="form-horizontal" method="post">
									    ...
									    <li class="disabled"><a href="#" aria-label="Previous"><span aria-hidden="true">&laquo;</span></a></li>
											<c:forEach var="page" items="${pList}">
												<c:choose>
													...
													<c:otherwise>
														<li><a href="../admin/adminServlet?action=purchaseMonthly&page=${page}">${page}</a></li>
													</c:otherwise>
												</c:choose>
											</c:forEach>
